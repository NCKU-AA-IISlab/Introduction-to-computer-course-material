...
class lane_controller(object):
    ...
    def setGains(self):
        v_bar = 0.2 # nominal speed, 0.5m/s
        k_lon = -2.0
    ...
    def cbPose(self,lane_pose_msg):
        ...
        rospy.loginfo("controls: speed %f, steering %f" % (car_control_msg.v, car_control_msg.omega ))
        rospy.loginfo("x %f , y %f"% (lane_pose_msg.x , lane_pose_msg.y  ))
        rospy.loginfo("-------------------------------------------")
