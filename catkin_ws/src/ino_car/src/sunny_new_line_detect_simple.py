...
class LineDetectorNode(object):
    def __init__(self):
        ...
        self.top_width = 0.7  # ditto for top edge of trapezoid
    ...
    def _colorFilter(self,hsv,color):
        """
         _colorFilter : 
         	1. extract color (red/white/yellow) from image
         	2. draw color space image(debug)
          INPUT: image
          OUTPUT: bitwised image, color space image
    ...
    def detectLines(self,img,color,img_shape):
        """
        detectLines : 
         	detector the lines from img.
         	
          INPUT: image, color, image shape
          OUTPUT: left lane line ,right lane line ,all line segments
    ...
    def cbImage(self, image_msg):
        '''
          callback function of image : start the processing thread
          INPUT: iamge
          OUTPUT:
        '''
